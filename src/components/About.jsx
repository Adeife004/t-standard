...
const milestones = [
  { year: '2014', title: 'Founded', desc: 'T-Standard was established in Isheri Oshun, Lagos with a vision to raise the standard of security and interior craftsmanship in Nigeria.' },
  { year: '2016', title: 'First 100 Doors', desc: 'Completed installation of over 100 custom security doors across residential properties in Lagos State.' },
  { year: '2019', title: 'Training Academy', desc: 'Launched our vocational training program empowering young Nigerians with marketable skills in fabrication and finishing.' },
  { year: '2022', title: 'Expanded Services', desc: 'Grew into a full interior solutions provider covering kitchens, wardrobes, POP ceilings and exterior finishing.' },
  { year: '2024', title: '500+ Projects', desc: 'Surpassed 500 completed projects with a growing team of skilled artisans serving clients across Nigeria.' },
]
  ...
  return (
    ...
    >
      <div style={{
        ...
        <Icon size={22} color={hovered ? '#fff' : value.color} style={{ transition: 'color 0.3s' }} />
      </div>
      <h4 style={{
        ...styles.valueTitle,
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ ...styles.timelineYear, color: hovered ? '#FF6600' : '#999' }}>
          {milestone.year}
        </span>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ ...styles.subheading, fontSize: isMobile ? '14px' : '16px' }}>
            Born in Lagos, built on craftsmanship. A decade of raising the bar on
            security, design and interior excellence across Nigeria.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={styles.storyCol}>
            ...
            <h3 style={{
              ...
              Setting the standard for security and interior excellence in Nigeria
            </h3>

            <p style={{ ...styles.storyText, fontSize: isMobile ? '14px' : '15px' }}>
              T-Standard was founded with one belief: Nigerians deserve world class quality
              at honest prices. From our workshop in Isheri Oshun, Lagos, we fabricate
              and install premium security doors, deliver flawless interior and exterior
              finishing, and craft bespoke kitchens and wardrobes that transform living spaces.
            </p>

            <p style={{ ...styles.storyText, fontSize: isMobile ? '14px' : '15px' }}>
              What started as a small fabrication outfit has grown into a full service
              interior solutions company trusted by hundreds of homeowners, landlords and
              developers across Lagos and beyond. Every project carries our name and our
              reputation, so we never cut corners.
            </p>
            ...
            <div style={styles.locationCard}>
              ...
              <div>
                ...
                <div style={styles.locationAddr}>B/Stop Isheri Oshun, Lagos, Nigeria</div>
              </div>
            </div>
